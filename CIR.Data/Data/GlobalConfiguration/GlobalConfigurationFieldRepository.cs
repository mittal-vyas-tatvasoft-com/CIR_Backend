	...
	public class GlobalConfigurationFieldRepository : IGlobalConfigurationFieldRepository
	{
		...
		public async Task<IActionResult> GetAllFields()
		{
			try
			{
				...
				return new JsonResult(new CustomResponse<List<GlobalConfigurationField>>() { StatusCode = (int)HttpStatusCodesAndMessages.HttpStatus.Success, Result = true, Message = HttpStatusCodesAndMessages.HttpStatus.Success.GetDescriptionAttribute(), Data = globalConfigurationField });
