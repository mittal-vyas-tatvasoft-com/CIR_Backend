...
namespace CIR.Common.Helper
{
    ...
    {
        private RolePriviledgesEnum _rolePriviledgesEnum;
        public CustomPermissionFilter(RolePriviledgesEnum rolePriviledgesEnum)
        {
            _rolePriviledgesEnum = rolePriviledgesEnum;
        }
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (roleData.Result != null)
            {
                ...
                {
                    if (roleData.Result.Roles.Any(x => x.site.Any(x => x.Languages.Any(x => x.Privileges.Any(x => x.PrivilegesId == (int)_rolePriviledgesEnum)))))
                    {
                        return;
                    }
